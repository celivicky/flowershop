   	...
   	<?php foreach($data as $y):?>
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox" href="categoria.php?id=<?php echo  $y->idcat; ?>" style="cursor: pointer;">
							...
							<img class="img-fluid" src="https://images.pexels.com/photos/15613455/pexels-photo-15613455/free-photo-of-restaurante-flores-mesas-sillas.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Gallery Images">
						</a>
					</div>
   	<?php endforeach; ?>
   	    <?php else:?>
