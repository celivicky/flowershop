...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>  
   	...
   	<input type="hidden" name="prdt" value="<?php echo $y->idpro; ?>">
    <input type="hidden" name="pdrus" value="<?php echo $_SESSION['id']; ?>">
    <input type="hidden" name="name" value="<?php echo $y->nompro; ?>">
    <input type="hidden" name="prec" value="<?php echo $y->prec1; ?>">
   		
						<div class="blog-inner-box">
							<div class="side-blog-img">
								<img class="img-fluid" src="https://placehold.co/900x500.png" alt="">							
    ...
    <?php endif; ?>
						...
						<div class="blog-comment-box">
							...
							<div class="comment-item">
								<div class="comment-item-left">
									<img src="https://placehold.co/470x570.png" alt="">
								</div>
								<div class="comment-item-right">
									<div class="pull-left">
										<a href="#">Rubel Ahmed</a>
   	...
   	<?php foreach($data as $ab):?>
								<div class="recent-box-blog">
									<div class="recent-img">
										<img class="img-fluid" src="https://placehold.co/80x80.png" alt="">
									</div>
									<div class="recent-info">
										<ul>
											<li><i class="zmdi zmdi-time"></i>Precio : <span>s/<?php echo  $ab->prec1; ?></span></li>
										</ul>
