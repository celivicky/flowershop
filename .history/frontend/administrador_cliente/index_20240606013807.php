		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="https://images.pexels.com/photos/4612200/pexels-photo-4612200.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="img-fluid">
				</div>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>  
   	...
   	<input type="hidden" name="prdt" value="<?php echo $a->idpro; ?>">
    <input type="hidden" name="pdrus" value="<?php echo $_SESSION['id']; ?>">
    <input type="hidden" name="name" value="<?php echo $a->nompro; ?>">
    <input type="hidden" name="prec" value="<?php echo $a->prec1; ?>">
			<div class="col-lg-4 col-md-6 special-grid drinks">
					<div class="gallery-single fix">
						<img src="https://images.pexels.com/photos/931168/pexels-photo-931168.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="img-fluid" alt="Image">
					...
					<button class="btn btn-common disabled" type="submit" name="add_to_cart" style="pointer-events: all; cursor: pointer;"> Añadir al carrito</button>
			</div>
   		</form>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   	...
   	<?php foreach($data as $y):?>
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox" href="categoria.php?id=<?php echo  $y->idcat; ?>" style="cursor: pointer;">
							<img class="img-fluid" src="https://placehold.co/800x480.png" alt="Gallery Images">
						</a>
					</div>
   	<?php endforeach; ?>
   	    <?php else:?>
   ...
   <?php
    include_once '../../backend/php/st_addcart_client.php'
	?>
</body>
</html>
