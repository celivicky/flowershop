 ...
 <div class="container">
  <div class="row">
   ...
   ?>
    ...
    <td><span>s/<?php echo number_format($sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']), 2); ?></span></td>
...
<?php
	...
	<tbody>
		<tr>
			<td><center>Bs/<?php echo number_format($cart_grand_total, 2); ?></center></td>
