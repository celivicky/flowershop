			 	...
			 	<div class="col-lg-12 col-md-12">
			 		<div class="card" style="min-height: 485px">
			 			<div class="card-header card-header-text">
                            <h4 class="card-title">Usuarios añadidos recientemente</h4>
                            <p class="category">Nuevos usuarios añadidas el dia de hoy</p>
...
if($sentencia){
  ...
  <form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
    ...
    <div class="col-md-4 col-lg-12">
        <div class="form-group">
            <label for="email2">Nombres y apellidos del usuario</label>
            <input type="text" required="" value="<?php echo  $f->nombre  ; ?>"  class="form-control" id="" name="txtname" placeholder="ejmp: joe doe">
            <input type="hidden" value="<?php echo  $f->id  ; ?>" name="txtid">
        ...
        <div class="form-group">
            ...
            <input type="text" required="" value="<?php echo  $f->usuario  ; ?>"  class="form-control" id="" name="txtusu" placeholder="ejmp: joe doe">
            <small id="emailHelp2" class="form-text text-muted"></small>
            <span id="error-name" class="badge badge-danger"></span>
        </div>
    </div>
        ...
        <div class="col-md-4 col-lg-6">
        <div class="form-group">
            <label for="email2">Correo del usuario</label>
            <input type="email" required="" value="<?php echo  $f->correo  ; ?>"  class="form-control" id="" name="txtcorr" placeholder="ejmp: joe doe">
            <small id="emailHelp2" class="form-text text-muted"></small>
            <span id="error-name" class="badge badge-danger"></span>
        </div>
    </div>
 ...
 <div class="form-group">
        <div class="col-sm-12">
            <button name='stupdusrr' class="btn btn-success text-white"><i class='material-icons' data-toggle='tooltip' title='crear'>save</i>Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../accesos/usuarios.php"><i class='material-icons' data-toggle='tooltip' title='crear'>close</i>Cancelar</a>
        </div>
    </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card" style="min-height: 485px">
                        <div class="card-header card-header-text">
                            ...
                            <p class="category">Nueva contraseña</p>
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
        ...
        <div class="form-group">
            ...
            <input type="password" required=""   class="form-control" id="" name="txtnewpsd" placeholder="ejmp: *******">
            <input type="hidden" value="<?php echo  $fa->id  ; ?>" name="txtid">
            <small id="emailHelp2" class="form-text text-muted"></small>
            <span id="error-name" class="badge badge-danger"></span>
        </div>
    </div>
                               ...
                               <div class="form-group">
        <div class="col-sm-12">
            <button name='stupdusrrpsd' class="btn btn-success text-white"><i class='material-icons' data-toggle='tooltip' title='crear'>save</i>Actualizar</button>                       
            <a class="btn btn-danger text-white" href="../accesos/usuarios.php"><i class='material-icons' data-toggle='tooltip' title='crear'>close</i>Cancelar</a>
        </div>
    </div>
                          </form>
...
<?php
    include_once '../../backend/php/st_updussrs.php'
?>
<?php
    include_once '../../backend/php/st_updussrspsd.php'
?>
</body>
</html>
