			 	...
			 	<div class="col-lg-12 col-md-12">
			 		<div class="card" style="min-height: 485px">
			 			<div class="card-header card-header-text">
                            ...
                            <p class="category">Nuevo delivery añadidas el dia de hoy</p>
       ...
       <tbody>
           <?php foreach($data as $g):?>
            <tr>
                ...
                <td><?php echo  $g->distri; ?> </td>
                <td><?php echo  $g->direcenvio; ?> </td>
                <td><?php echo  $g->refer; ?> </td>
                <td><?php echo  $g->deen; ?> </td>
                <td><?php echo  $g->paren; ?> </td>
                <td><?php echo  $g->mendedi; ?> </td>
