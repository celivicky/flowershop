			 	...
			 	<div class="col-lg-12 col-md-12">
			 		<div class="card" style="min-height: 485px">
			 			<div class="card-header card-header-text">
                            <h4 class="card-title">Categorias añadidos recientemente</h4>
                            <p class="category">Nuevas categorias añadidas el dia de hoy</p>
                            <a data-toggle="modal" href="#newcate" class="btn btn-danger text-white"><i class='material-icons' data-toggle='tooltip' title='crear'>add</i>Nueva categoria</a>
                            <a href="../pdf/pdf_category.php" class="btn btn-danger text-white"><i class='material-icons' data-toggle='tooltip' title='crear'>picture_as_pdf</i>Reporte categoria</a>
                         </div>
   ...
   <?php if(count($data)>0):?>
       ...
       <tbody>
           <?php foreach($data as $g):?>
            <tr>
                ...
                <?php    if($g->estado =='1')  { ?>
                <a class="btn btn-danger text-white" data-toggle="modal" href="#close_<?php echo  $g->idcat; ?>"><i class='material-icons' data-toggle='tooltip' title='cancel'>cancel</i></a>
                <a class="btn btn-warning text-white" data-toggle="modal" href="#edit_<?php echo  $g->idcat; ?>"><i class='material-icons' data-toggle='tooltip' title='edit_note'>edit_note</i></a>


                        <?php  }   else {?> 
                <a class="btn btn-success text-white" data-toggle="modal" href="#done_<?php echo  $g->idcat; ?>"><i class='material-icons' data-toggle='tooltip' title='done'>done</i></a>
                            <?php  } ?>   
                </td>
    ...
    <span class="badge badge-danger">Desactivado</span>
     <?php  } ?> </td>
            ...
            <?php include '../../backend/modal/mdaeditcat.php';  ?>
            <?php endforeach; ?>
       </tbody> 
    </table>
    <?php else:?>
...
<?php
    include_once '../../backend/php/st_adddcate.php'
?>
<?php
    include_once '../../backend/php/st_updcate.php'
?>
<?php
    include_once '../../backend/php/st_upddescate.php'
?>
<?php
    include_once '../../backend/php/st_updactcate.php'
?>
</body>
</html>
