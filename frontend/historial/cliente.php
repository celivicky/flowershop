			 	...
			 	<div class="col-lg-12 col-md-12">
			 		<div class="card" style="min-height: 485px">
			 			<div class="card-header card-header-text">
                            ...
                            <a data-toggle="modal" href="#newclie" class="btn btn-danger text-white"><i class='material-icons' data-toggle='tooltip' title='crear'>add</i>Nuevo cliente</a>
   ...
   <?php if(count($data)>0):?>
       ...
       <tbody>
           <?php foreach($data as $g):?>
            <tr>
                ...
                <?php    if($g->estado =='1')  { ?>
                <a class="btn btn-danger text-white" data-toggle="modal" href="#close_<?php echo  $g->idclie; ?>"><i class='material-icons' data-toggle='tooltip' title='cancel'>cancel</i></a>
                <a class="btn btn-warning text-white" data-toggle="modal" href="#edit_<?php echo  $g->idclie; ?>"><i class='material-icons' data-toggle='tooltip' title='edit_note'>edit_note</i></a>
                <a class="btn btn-dark text-white" data-toggle="modal" href="#key_<?php echo  $g->idclie; ?>"><i class='material-icons' data-toggle='tooltip' title='key'>key</i></a>


                        <?php  }   else {?> 
                <a class="btn btn-success text-white" data-toggle="modal" href="#done_<?php echo  $g->idclie; ?>"><i class='material-icons' data-toggle='tooltip' title='done'>done</i></a>
                            <?php  } ?>   
                </td>
    ...
    <span class="badge badge-danger">Desactivado</span>
     <?php  } ?> </td>
            ...
            <?php include '../../backend/modal/mdaeditcust.php';  ?>
            <?php endforeach; ?>
       </tbody> 
    </table>
    <?php else:?>
...
<div class="alert alert-warning" role="alert">
  No se encontró ningún dato!
    ...
    <?php include('../../backend/modal/modanewcust.php'); ?>
...
<?php
    include_once '../../backend/php/st_adddcustomer.php'
?>
<?php
    include_once '../../backend/php/st_updcustomer.php'
?>
<?php
    include_once '../../backend/php/st_upddescustomer.php'
?>
<?php
    include_once '../../backend/php/st_updactcustomer.php'
?>
<?php
    include_once '../../backend/php/st_updpsdcustomer.php'
?>
</body>
</html>
